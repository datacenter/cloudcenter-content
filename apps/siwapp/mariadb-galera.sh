...
sudo yum update -y
sudo yum -y install MariaDB-server MariaDB-client galera less which socat pwgen firewalld nmap wget
...
wget https://raw.githubusercontent.com/datacenter/cloudcenter-content/siwapp/apps/siwapp/siwapp-galera-fixup.sh -P /usr/share/systemd/siwapp
